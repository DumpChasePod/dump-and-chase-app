const CACHE='dump-chase-v152';
const ASSETS=['./','./index.html','./dump-chase-logo.png','./sam-olmstead.jpg','./justin-irwin.jpg','./dan-conley.jpg','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png','./favicon-32.png','./og-card.png'];
